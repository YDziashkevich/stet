<div class="center-text">
    ...
    <a href="#win2" class='button float_r btn-large btn btn-info'
       style='margin-top: -30px; margin-right: 20px; color: white; ' id="infoTree">INFO</a>
    ...
    <div class="popup">
        ...
        <div id="popup_text"
        <p>
            Разработать структуру базы данных для хранения информации о дереве каталогов файловой системы - директории,
            файлы). Написать программу для:<br/>
            <br/>
